...
Súvisí: [Vetva Hajman-Škodiová](vetva-hajman-skodiova.md) (Jozef Ličko ⚭ Irena Hajmanová; Lorenowiczovci podrobne tam) · [Prehľad](prehlad.md)
...
Obe sa narodili ako **Ličkové**, po adopcii Petrom Lorenowiczom boli **Lorenowiczové**:

- **Marta** (mama) \*16.1.1970 Košice — rod. **Ličková** → adopt. **Lorenowiczová** → vyd. **Rusinková**.
- **Zdena** (mamina sestra) \*1966 — rod. **Ličková** → adopt. **Lorenowiczová** → dnes **Diana Fünfer**; dcéra **Vivien**.
